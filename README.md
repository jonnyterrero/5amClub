...
## Deployment
Drag and drop this folder into [Netlify](https://app.netlify.com/drop).
...
- **Course Notes**: Dedicated notes for each course.
- **Progress Tracking**: Visual progress bars and dashboard charts.
- **Mobile Optimized**: Full sidebar navigation on mobile.
